...
|----|----------|--------|-------|---------|------|
| F-0001 | P1 | In Progress | H100 Gemma 3 27b Inference Expansion | TBD | [F-0001](specs/F-0001-h100-gemma-3-27b-inference-expansion.md) |
...
| T-0002 | F-0001 | Create Offline Batch Inference manifests for H100 Gemma 3 27b | SWE-2 | Failed |
...
| T-0006 | F-0001 | Fix Offline Batch Inference resource patch (limit to 1 GPU) | SWE-2 | In Progress |
